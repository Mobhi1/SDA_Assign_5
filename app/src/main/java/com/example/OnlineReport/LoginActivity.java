...
public class LoginActivity extends AppCompatActivity {
    ...
    // --Commented out by Inspection (25/04/2020 20:26):private FirebaseAuth.AuthStateListener authStateListener;
    private static final String TAG = "LoginActivity";

    /**
     * This provides access to the Firebase Authentication Login
     * @param savedInstanceState  Bundle containing the previous instance state
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Toast.makeText(LoginActivity.this.getApplicationContext(), "starting MainActivity",Toast.LENGTH_LONG
        ).show();

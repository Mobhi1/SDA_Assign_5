package com.example.john.onlinereport;
    ...
    protected void getLastAddress(){
        ...
        mFusedLocationClient.getLastLocation()
                ...
                if (location != null) {
                    ...
                    try {
                        //List<Address> addresses = geocoder.getFromLocationname(51.8170n\applyOverrideConfiguration();01, -8.315781,2);
                        List<Address> addresses = geocoder.getFromLocation(52.637193 , -7.235688,1);
                        ...
                        if(!finalAddress.equals("")) {
                            ...
                            //mCoordinate.setText(addresses.get(0).getLocality());
                            //mCoordinate.setText(addresses.get(0).getCountryName());
                            //mCoordinate.setText(addresses.get(0).getAdminArea()); //County Dublin
                            mCoordinate.setText(addresses.get(0).getAdminArea().substring(7));
                        } else {
    ...
    private void checkPermissions(){
        ...
        if (ContextCompat.checkSelfPermission(getLocation.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(getLocation.this,
                    Manifest.permission.ACCESS_FINE_LOCATION) && ActivityCompat.shouldShowRequestPermissionRationale(getLocation.this,
